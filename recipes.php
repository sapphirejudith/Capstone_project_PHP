      ...
      <div class="container mt-5">
        ...
        <div class="row">
			<div class="col-8">
    			<div class="form">  
				  ...
				  <Form  method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					<label> Recipe Name <span style="color:#FF0000">* <?php echo $recipe_nameErr;?></span></label> <br>
					<input type="text" name="recipe_name"  class="form-control"/><br>
					<label> Recipe Ingredients <span style="color:#FF0000">* <?php echo $recipe_ingredientsErr;?></span></label> <br>
					<input type="text" name="recipe_ingredients"  class="form-control"/><br>
					<label> Recipe Description <span style="color:#FF0000">* <?php echo $recipe_descErr;?></span> </label> <br>
					...
					if ($recipe_nameErr == "" && $recipe_ingredientsErr =="" && $recipe_descErr ==""){
					if (isset($_POST['submit'])) {
			 		$recipe_name = $_POST['recipe_name'];
					$recipe_ingredients = $_POST['recipe_ingredients'];
					$recipe_desc = $_POST['recipe_desc'];
							
						$qe = query("INSERT INTO recipes set
            ...
            <div class="icon-box">
			  ...
			  <a href="view_recipes.php" class="btn"><i class="bx bx-arrow-to-right"></i></a>
			  </div>
